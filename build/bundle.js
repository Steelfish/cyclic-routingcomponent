...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(drivers) {
	  return (0, _main2.default)(drivers);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createHashHistory2 = __webpack_require__(94);

	var _createHashHistory3 = _interopRequireDefault(_createHashHistory2);

	var _createMemoryHistory2 = __webpack_require__(96);

	var _createMemoryHistory3 = _interopRequireDefault(_createMemoryHistory2);

	var _useBasename2 = __webpack_require__(97);

	var _useBasename3 = _interopRequireDefault(_useBasename2);

	var _useBeforeUnload2 = __webpack_require__(98);

	var _useBeforeUnload3 = _interopRequireDefault(_useBeforeUnload2);

	var _useQueries2 = __webpack_require__(99);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _queryString = __webpack_require__(100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _snabbdomJsx = __webpack_require__(104);

	"use strict";
	var isolate_1 = __webpack_require__(105);
	var states_tsx_1 = __webpack_require__(106);
	var ComponentRouter_tsx_1 = __webpack_require__(107);
	var routes = {
	    '/': ComponentRouter_tsx_1.createRedirect("/hello"),
	    '/state': states_tsx_1.default
	};
	function Main(sources) {
	    var page = ComponentRouter_tsx_1.default({ router: sources.router, DOM: sources.DOM, routes: routes });
	    var sinks = {
	        DOM: page.DOM,
	        router: page.router
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentRouter_tsx_1 = __webpack_require__(107);
	var routes = {
	    '/': ComponentRouter_tsx_1.createRedirect('/substate2'),
	    '/substate': Substate1,
	    '/substate2': Substate2
	};
	function State(sources) {
	    var page = ComponentRouter_tsx_1.default({ router: sources.router, DOM: sources.DOM, routes: routes });
	    var sinks = {
	        DOM: page.DOM.map(function (page) {
	            return (0, _snabbdomJsx.html)(
	                ...
	                (0, _snabbdomJsx.html)(
	                    'h1',
	                    null,
	                    'I am the parent state'
	                ),
	                page,
	                (0, _snabbdomJsx.html)(
	                    'a',
	                    { href: sources.router.createHref('/') },
	                    'State'
	                ),
	                (0, _snabbdomJsx.html)('br', null),
	                (0, _snabbdomJsx.html)(
	                    'a',
	                    { href: sources.router.createHref('/substate') },
	                    'Substate 1'
	                ),
	                (0, _snabbdomJsx.html)('br', null),
	                (0, _snabbdomJsx.html)(
	                    'a',
	                    { href: sources.router.createHref('/substate2') },
	                    'Substate 2'
	                ),
	                (0, _snabbdomJsx.html)('br', null)
	            );
	...
	function Substate1(sources) {
	    return {
	        DOM: xstream_1.default.of((0, _snabbdomJsx.html)(
	            'h1',
	            null,
	            'Substate 1'
	        ))
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = function (sources) {
	    return isolate_1.default(State)(sources);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function flattenByKey(key, stream) {
	    return stream.map(function (x) {
	        return propOrNever(key, x);
	    }).flatten();
	}
	function ComponentRouter(sources) {
	    var component$ = sources.router.define(sources.routes).map(function (route) {
	        return callComponent(sources)(route);
	    });
	    var pluck = function pluck(key) {
	        return flattenByKey(key, component$);
	    };
	    var sinks = {
	        pluck: pluck,
	        DOM: pluck('DOM'),
	...
	function createRedirect(path) {
	    var redirect = function redirect(sources) {
	        var vTree = xstream_1.default.of((0, _snabbdomJsx.html)(
	            'div',
	            null,
	            'Redirecting...'
	        ));
	        var redirect$ = xstream_1.default.of(sources.router.createHref(path));
	        return {
	            DOM: vTree,
	            router: redirect$
	        };
	    ...
	    return function (sources) {
	        return isolate_1.default(redirect)(sources);
	    };
	}
	exports.createRedirect = createRedirect;
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = function (sources) {
	    return isolate_1.default(ComponentRouter)(sources);
	};
